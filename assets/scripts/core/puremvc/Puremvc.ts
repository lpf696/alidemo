...
export class Model implements IModel {
    ...
    removeAllProxy(exculde:Array<string>) {
        for (const proxyName in this.proxyMap) {
            if (exculde && exculde.indexOf(proxyName) == -1) {
...
export class View implements IView {
    ...
    removeAllMediator(exclude:Array<string>)
    {
        for (const key in this.mediatorMap) {
...
export interface IFacade extends INotifier {
    ...
    removeAllProxy(exculde:Array<string>): void;
...
export class Facade implements IFacade {
    ...
    removeAllProxy(exculde:Array<string>): void {
        this.model.removeAllProxy(exculde);
    }
    ...
    removeAllMediator(exclude:Array<string>)
    {
        if (this.view) this.view.removeAllMediator(exclude);
    }
